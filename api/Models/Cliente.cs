...
{
  public class Cliente : EntidadeTenant, IAlphaExpressRef, IUsuarioLog, IDateLog
  {
    ...
    public ClienteStatusSincronizado Sincronizado { get; set; }
  ...
  public enum ClienteStatusSincronizado : Int16
  {
    CadastradoApp,
    CadastradoAlpha
  }
