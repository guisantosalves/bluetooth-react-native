...
namespace Alpha.Pesagem.Api.Resolvers
{
  ...
  {
    public const string TenantImagemUrl = "TenantImagemUrl";

    public const string TenantId = "TenantId";

    public const string SubEmpresaId = "SubEmpresaId";

    public const string TenantCnpj = "TenantCnpj";

    public const string TenantNome = "TenantNome";
    public const string NivelAcesso = "NivelAcesso";
  }
