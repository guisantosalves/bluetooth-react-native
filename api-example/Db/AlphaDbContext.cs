...
namespace Alpha.Pesagem.Api.Data
{
  public class AlphaDbContext : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      modelBuilder.ApplyConfiguration(new ConfiguracaoModelConfiguration());
      modelBuilder.ApplyConfiguration(new EmpresaModelConfiguration());
      modelBuilder.ApplyConfiguration(new FinanceiroModelConfiguration());
      ...
      // Criação de índices
      modelBuilder.Entity<Cliente>().HasIndex(em => em.EmpresaId);
      
      modelBuilder.Entity<Configuracao>().HasIndex(em => em.EmpresaId);
      modelBuilder.Entity<Financeiro>().HasIndex(em => em.EmpresaId);
      ...
      modelBuilder.Entity<Cliente>().HasQueryFilter(e => e.EmpresaId == this.Tenant.Id);
      modelBuilder.Entity<Configuracao>().HasQueryFilter(e => e.EmpresaId == this.Tenant.Id);
      modelBuilder.Entity<Financeiro>().HasQueryFilter(e => e.EmpresaId == this.Tenant.Id);
